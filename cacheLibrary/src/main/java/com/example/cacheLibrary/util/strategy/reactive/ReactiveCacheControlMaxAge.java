...
public class ReactiveCacheControlMaxAge implements IStrategy {
  ...
  public CacheControlStrategyResponse cacheControlStrategy(
    ...
    //   boolean cached = cacheRepository.add(cacheModel.collection, cacheModel.hkey,
    // cacheModel.object, Integer.parseInt(maxage[1]) , TimeUnit.SECONDS);
    Mono cached =
    ...
    return new CacheControlStrategyResponse(
        cached.equals(true), Integer.parseInt(maxage[1]), HttpStatus.OK);
  }
}
